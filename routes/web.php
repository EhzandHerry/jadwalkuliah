...
Route::get('/admin/dosen/{id}/available', [AdminController::class, 'editAvailableTime'])
     ->name('admin.available.edit');
...
Route::get('/admin/dosen/{id}/available', [AdminController::class, 'manageAvailable'])
     ->name('admin.available.manage');
